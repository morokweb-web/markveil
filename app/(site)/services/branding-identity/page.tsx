export const metadata = {
  ...
  description: "Logos, visual systems, guidelines, and cohesive brand presence.",
  ...
  return (
    <>
      <section className="relative h-[50vh] overflow-hidden">
        <img src="/img/services/hero.png" alt="Branding & Identity" className="absolute inset-0 h-full w-full object-cover ken-burns" />
        <div className="absolute left-1/2 -translate-x-1/2 top-10 text-center px-4">
          <div className="text-panel text-panel--loose inline-block max-w-3xl">
            <h1 className="h1 mb-0">Branding & Identity</h1>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="mx-auto max-w-3xl px-4 space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4 pt-4">
            <img src="/img/services/gallery/gallery-05.png" className="w-full h-56 object-cover rounded-2xl border border-neutral-200 dark:border-neutral-800" alt="" />
            <img src="/img/services/gallery/gallery-06.png" className="w-full h-56 object-cover rounded-2xl border border-neutral-200 dark:border-neutral-800" alt="" />
          </div>
        </div>
      </section>
    </>
